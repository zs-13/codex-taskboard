...
const EVENT_NAMES = [
  ...
  "task.blocked",
  "task.unblocked",
  "task.control.updated",
  "task.locked",
  "task.dependency.updated",
  "task.dependency.released",
  "squad.autonomous.step",
] as const;
...
export function App() {
  ...
  const mainStatuses = MAIN_STATUSES;
                    ...
                    {mainStatuses.map((status) => (
                      <BoardColumn
                        ...
                        emptyMessage={hasActiveTaskFilters
                          ...
                          : text(
                            `${taskStatusLabel(language, status)}为空`,
                            `${taskStatusLabel(language, status)} is empty`,
                          )}
